...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Muhamad Taufiq Riza's Portfolio App regarding TikTok API integration",
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            developer&apos;s (Muhamad Taufiq Riza) public TikTok content for
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            contact the developer at: <strong>muhamad.taufiqriza@gmail.com</strong>.
          </p>
        </section>
      </div>
    </Container>
